...
int MapLoader::_mapH = 0;
 ...
 int MapLoader::_apple = 10;
 int MapLoader::_life = 3;
 int MapLoader::_health = 10;
 int MapLoader::_jewel = 0;
 int MapLoader::_timeInGame = -1;

 int MapLoader::_aladdinX = 2; //vị trí của alladin TILE
 int MapLoader::_aladdinY = 2;
...
void MapLoader::TranslateMap (QuadTree* quadtree, BackgroundManager* background, Aladdin* alladin, int &timeInGame)
{
	////
	...
	////alladin
	//alladin->_x = _aladdinX * TILE;
	//alladin->_y = _aladdinY * TILE;
	...
	//	alladin->life = _life;
	//	alladin->exp = _exp;
	//	alladin->_State = (State)_marioState;
	//}	
...
void MapLoader::SaveGameToFile(QuadTree* quadtree, Aladdin* aladdin, int timeInGame, LPCTSTR fileToSave)
{
...
//	MapLoader::_marioState = -1; //state of alladin
//	MapLoader::_timeInGame = -1;
//
//	MapLoader::_mariox = 2; //vị trí của alladin TILE
//	MapLoader::_marioy = 2;
//
