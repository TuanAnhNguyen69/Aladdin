...
void QuadTree::UpdateRender(CRECT camera, Aladdin* aladdin, int time)
{
...
#pragma endregion
	...
	aladdin->UpdateRealTimeCollision(time,listUpdate);
	if(aladdin->_State != dead)
		listUpdate1->push_back(aladdin);
